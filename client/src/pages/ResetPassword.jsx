...
const ResetPassword = () => {
  ...
  const navigate = useNavigate()
    const handleResetPassword = async(e) => {
      ...
      try {
        setLoading(true) ;
        const res = await axios.put("https://glamourfullstack.onrender.com/api/reset-password" , {
          email
        } )
        ...
        loading ? (<Spinner/>) : (
         ...
         >
           ...
           />
             ...
             <button type="submit" className="outline-none border rounded-md px-3 py-2 text-white bg-green-500 hover:bg-green-300   " >Send Otp</button>
